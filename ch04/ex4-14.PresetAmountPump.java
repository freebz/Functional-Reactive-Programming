// 리스트 4-14 주유 금액 설정 기능을 포함한 완전한 주유 펌프 구현
...
import chapter4.section6.AccumulatePulsePump;
...
public class PresetAmountPump import Pump {
	...
	return new Outputs()
	    ...
	    .setSaleQuantityLCD(fi.literDelivered.map(
