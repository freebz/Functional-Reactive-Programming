...
public class Preset {
	...
	Cell<Speed> speed = presetDollars.lift(
	    fi.price, fi.dollarsDelivered, fi.literDelivered,
	    (presetDollars_, price, dollarsDelivered, literDelivered) -> {
		if (presetDollars_ == 0)
		    return Speed.FAST;
		else {
