	...
	super((size, sMouse, sKey, focus, idSupply) -> {
		...
		Fridget.Output fo = new FrTranslate(fridget,
		    dir == Direction.HORIZONTAL
		        ? desiredSize.map(dsz -> new Demension(dsz.width, 0))
			: desiredSize.map(dsz -> new Demension(0, dsz.height)))
